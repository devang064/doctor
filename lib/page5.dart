...
import 'package:doctor/homedoc.dart';
import 'package:doctor/page4.dart';
                      ...
                      showDialog(
                          ...
                          builder: (context){
                            return AlertDialog(
                              ...
                              content: const Text('Congratulations, Your phone number has been successfully verified.',textAlign: TextAlign.center,style: TextStyle(color:Colors.black26 ),),
                              actions: <Widget>[
                                Center(
